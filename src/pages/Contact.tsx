  ...
  return (
    <>
      ...
      <Container className="grid grid-cols-1 gap-12 py-14 lg:grid-cols-3">
        ...
        <form onSubmit={onSubmit} className="space-y-5 rounded-2xl border border-ink-900/8 bg-white p-6 lg:col-span-2 sm:p-8">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <label className="flex flex-col gap-1.5 text-xs font-medium text-ink-700/70">
              ...
              <input
                ...
                className="rounded-lg border border-ink-900/10 px-3 py-2 text-sm text-ink-900 focus:border-brand-400"
              />
            </label>
            <label className="flex flex-col gap-1.5 text-xs font-medium text-ink-700/70">
          ...
          <label className="flex flex-col gap-1.5 text-xs font-medium text-ink-700/70">
            ...
            <textarea
              ...
              className="resize-y rounded-lg border border-ink-900/10 px-3 py-2 text-sm text-ink-900 focus:border-brand-400"
            />
          </label>
