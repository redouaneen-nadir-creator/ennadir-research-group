  ...
  return (
    <form onSubmit={onSubmit} role="search" className={`relative ${className}`}>
      ...
      <input
        ...
        className="w-full rounded border border-ink-900/15 bg-ink-900/[0.03] py-2 ps-9 pe-3 text-sm text-ink-900 placeholder:text-ink-700/40 focus:border-brand-400 focus:bg-white"
      />
    </form>
  )
}
